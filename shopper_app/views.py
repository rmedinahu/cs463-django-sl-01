...
class ItemView(generic.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['shopping_lists'] = self.get_object().shopping_lists.all()
        return context
...
class ShoppingListDeleteView(generic.DeleteView):
    model = ShoppingListItem
    template_name = 'shopping_list_item_confirm_delete.html'

    def get_success_url(self):
        deleted_item = self.get_object()
        return reverse('shopping_list', args=[deleted_item.shopping_list.pk])
